 ...
 */
public final class AsynchronousSocketChannelPool extends Pool<AsynchronousSocketChannel>
{
    /**
     *
     */
     ...
     */
    @Override
    protected AsynchronousSocketChannel create()
    {
        try
        {
     ...
     */
    @Override
    protected void reset(final AsynchronousSocketChannel object)
    {
        try
        {
