...
class Acceptor extends AbstractNioProcessor
{
    ...
    */
    ...
    /**
     * @see de.freese.jsync.server.AbstractNioProcessor#beforeSelectorWhile()
     */
    @Override
    ...
    /**
     * @see de.freese.jsync.server.AbstractNioProcessor#onAcceptable(java.nio.channels.SelectionKey)
     */
    @Override
